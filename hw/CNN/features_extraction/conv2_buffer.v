module conv2_buffer #(
    ...
    input  wire [BUS_WIDTH-1:0] in_pixels_256b,
    ...
    wire [5:0] max_ahead = (out_c == 0) ? 6'd3 : 6'd2;
    wire [5:0] col_distance = wr_col - out_c;
    ...
    wire [4:0] safe_r_up = (out_r == 0) ? 5'd0 : out_r - 1'b1;
    wire [4:0] safe_r_dn = (out_r == IMG_H - 1) ? out_r : out_r + 1'b1;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (write_en) begin
                mem[wr_ptr][in_r] <= in_pixels_256b;
